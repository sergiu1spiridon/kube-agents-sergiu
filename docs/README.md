...
| `docs/designs/testing-gap-analysis.md` | Feature design | Gap analysis of tests in code vs. CI pipelines, smoke test evaluation, and RC release candidate hardening recommendations. | Pipeline matrix, test gaps, smoke tests, RC feasibility | Engineering analysis and roadmap |
